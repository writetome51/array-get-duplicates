...
if (result.length === 2 && result[0] === false && result[1] === false) console.log('test 2 passed');
...
if (result.length === 0) console.log('test 5 passed');
...
if (result.length === 1 && result[0] === 22.00356789991112) console.log('test 6 passed');
...
if (result.length === 0) console.log('test 7 passed');
